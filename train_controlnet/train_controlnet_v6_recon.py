...
def parse_args(input_args=None):
    ...
    # Arguments for reconstruction loss
    parser.add_argument(
        "--use_reconstruction_loss",
        action="store_true",
        help="Whether or not to use reconstruction loss.",
    )
    parser.add_argument(
...
def main(args):
    ...
    if args.use_reconstruction_loss:
        logger.info("Initializing ConditionAutoencoder")
    ...
    controlnet.train()
    if condition_autoencoder is not None:
        condition_autoencoder.train()
    ...
    if args.use_reconstruction_loss:
        controlnet, condition_autoencoder, optimizer, train_dataloader, lr_scheduler = accelerator.prepare(
            controlnet, condition_autoencoder, optimizer, train_dataloader, lr_scheduler
        )
    else:

...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Path to pretrained unet model or model identifier from huggingface.co/models.(20250415-added)"
        )
    )
...
def main(args):
    ...
    # 2025/04/15 add shimoguchi
    if args.unet_model_name_or_path:
        print("DDDDDDDDDDDDDDDDDDDD Unet DDDDDDDDDDDDD")
